...
// 다수 개의 클라이언트와 데이터를 송수신하기 위해서
// 클라이언트와 데이터를 주고받을 수 있는 스트림 객체가 필요합니다.
// 일반적인 경우 클라이언트의 소켓과 입출력 스트림을 저장하고 사용할 수 있는
// 사용자 정의 클래스를 사용합니다.
public class Network_12_Server extends JFrame {
